...
class Amenity(models.Model):
    ...
    place = models.ForeignKey(
        "mainApp.Place", blank=False, on_delete=models.CASCADE)
...
class Reservation(models.Model):
    amenity_profile_relationship = models.ForeignKey(
        "mainApp.AmenityProfileRelationship", verbose_name=("AmenityRelationship for the Reservation"), blank=False, on_delete=models.CASCADE)
    place = models.ForeignKey(
        "mainApp.Place", blank=False, null=True, related_name="reservation_set", on_delete=models.CASCADE)
...
class AmenityProfileRelationship(models.Model):
    amenity = models.ForeignKey("mainApp.Amenity", verbose_name=(
        "Amenity in the relationship"), on_delete=models.CASCADE, related_name="amenity_of")
    profile = models.ForeignKey("mainApp.Profile", verbose_name=(
...
class PlaceProfileRelationship(models.Model):
    place = models.ForeignKey("mainApp.Place", verbose_name=(
...
class JoinRequest(models.Model):
    profile = models.ForeignKey(
        "mainApp.Profile", null=False, blank=False, on_delete=models.CASCADE)
    place = models.ForeignKey(
        "mainApp.Place",  null=False, blank=False, on_delete=models.CASCADE)
